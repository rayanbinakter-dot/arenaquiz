...
export const ictChap3QuestionsPart3: Question[] = [
  ...
  },
  {
    ...
    question_text: "৯৯. উদ্দীপকে কোন গেইটটির আউটপুট দেওয়া আছে? [য. বো. ২৩]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১০১. উদ্দীপকে যুক্ত বর্তনীটি কোন গেট নির্দেশ করে? [য. বো. ১৭]",
  ...
  },
  {
    id: 103,
    topic: "৬. লজিক গেইট",
    question_text: "১০৩. নিচের সার্কিটটির ক্ষেত্রে কখন আলো জ্বলবে না? [রা. বো. ২৫]\n[এখানে চিত্র ছিল]",
  ...
  },
  {
    id: 105,
    topic: "৬. লজিক গেইট",
    question_text: "১০৫. উভয় ইনপুট $1$ হলে আউটপুট $0$ হয় কোন গেইটে? [য. বো. ১৯]\ni. $\\mathrm{NAND}$\nii. $\\mathrm{NOR}$\niii. $\\mathrm{XNOR}$\nনিচের কোনটি সঠিক?",
    options: ["i ও ii", "i ও iii", "ii ও iii", "i, ii ও iii"],
    correct_answer: "i ও iii",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১০৮. উপরিউক্ত যুক্তি বর্তনীটি কোন গেট নির্দেশ করে? [দি. বো. ২৩]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১১০. উদ্দীপকের সত্যক সারণি যে গেট নির্দেশ করে তা হলো: [য. বো. ২৩]",
  ...
  },
  {
    id: 115,
    topic: "৬. লজিক গেইট",
    question_text: "১১৫. সার্বজনীন গেট তৈরিতে ব্যবহৃত হয়- [রা. বো. ২৩; অনুরূপ: চ. বো. ১৬]\n[এখানে চিত্র ছিল]\nনিচের কোনটি সঠিক?",
    options: ["i ও ii", "i ও iii", "ii ও iii", "i, ii ও iii"],
    correct_answer: "i, ii ও iii",
  ...
  },
  {
    id: 116,
    topic: "৬. লজিক গেইট",
    question_text: "১১৬. কোনটি $\\mathrm{NAND}$ গেট? [কু. বো. ১৭]\n[এখানে চিত্র ছিল]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১১৭. সত্যক সারণির লজিক গেইট কোনটি?",
    options: ["$\\mathrm{AND}$", "$\\mathrm{OR}$", "$\\mathrm{NOR}$", "$\\mathrm{NAND}$"],
    correct_answer: "$\\mathrm{NOR}$",
    explanation: "",
    time_limit: 30
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১১৮. $\\mathrm{X}$ কলমে 0 হলে 1 এবং 1 এর স্থলে 0 বসালে প্রাপ্ত গেইটটি হবে-\n[এখানে চিত্র ছিল]",
    options: ["[এখানে চিত্র ছিল]", "[এখানে চিত্র ছিল]", "[এখানে চিত্র ছিল]", "[এখানে চিত্র ছিল]"],
    correct_answer: "[এখানে চিত্র ছিল]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১১৯. উদ্দীপকের বর্তনীটির $\\mathrm{Q}$-এর মান কত? [রা. বো. ১৭]",
  ...
  },
  {
    id: 120,
    topic: "৬. লজিক গেইট",
    question_text: "১২০. [এখানে চিত্র ছিল] -চিত্রের আউটপুট হবে- [কু. বো. ২৩, ১৬; অনুরূপ: ঢা. বো. ২৩; দি. বো. ১৫]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১২১. উদ্দীপকের আউটপুট $\\mathrm{F}$ এর মান সরলীকৃত মান কোনটি? [চ. বো. ১৬; অনুরূপ: ঢা. বো. ২৩; য. বো. ১৬]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১২২. উদ্দীপকে [এখানে চিত্র ছিল] এর স্থলে [এখানে চিত্র ছিল] বসালে $\\mathrm{F}$ এর সরলীকৃত মান নিচের কোন গেইটকে সমর্থন করে? [চ. বো. ১৬]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১২৩. $\\mathrm{F}$-এর সরলীকৃত মান কোনটি? [য. বো. ২৫; অনুরূপ: মা. বো. ১৬]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১২৫. এখানে, $\\mathrm{P = ?}$ [দি. বো. ২৫; অনুরূপ: দি. বো. ২৫; ঢা. বো. ২৪, ২৩, ১৯; য. বো. ২৩; চ. বো. ২৩; সু. বো. ১৬]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১২৭. উদ্দীপকের $\\mathrm{Y}$ এর সমীকরণ কোনটি? [ঢা. বো. ২৫]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১২৮. উদ্দীপকে $\\mathrm{Y}$ এর মান 0, যখন- [ঢা. বো. ২৫; অনুরূপ: ব. বো. ২৩]\ni. $\\mathrm{A=1, B=0}$\nii. $\\mathrm{A=0, B=1}$\niii. $\\mathrm{A=1, B=1}$\nনিচের কোনটি সঠিক?",
    options: ["i ও ii", "i ও iii", "ii ও iii", "i, ii ও iii"],
    correct_answer: "i ও ii",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১২৯. $\\mathrm{P}$ এর সরলীকরণ মানের সমতুল্য গেইট কোনটি? [ব. বো. ২৪]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৩২. $\\mathrm{F}$ এর মান কোনটি? [রা. বো. ২৫]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৩৩. চিত্রে '2' নং গেইটের পরিবর্তে কোন গেইট স্থাপন করলে $\\mathrm{F = 0}$ হয়? [রা. বো. ২৫; অনুরূপ: ঢা. বো. ১৬]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৩৪. উদ্দীপকের আউটপুট $\\mathrm{F}$ এর সরলীকৃত মান হবে- [য. বো. ২৩]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৩৫. $\\mathrm{XOR}$ গেইটের স্থলে কোন গেইট বসালে আউটপুট 1 হবে? [ম. বো. ২৫]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৩৬. উদ্দীপকের $\\mathrm{F}$ এর সরলীকৃত মান হচ্ছে- [ব. বো. ২৪]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৩৮. উদ্দীপকে \"Y\" এর সরলীকৃত মান কোনটি? [য. বো. ২৫]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৪১. উদ্দীপক বর্তনীর আউটপুটের সরলীকরণ মান কোন গেইটের সাথে সাদৃশ্যপূর্ণ? [য. বো. ১৯]",
    options: ["$\\mathrm{NAND}$", "$\\mathrm{NOR}$", "$\\mathrm{XOR}$", "$\\mathrm{XNOR}$"],
    correct_answer: "$\\mathrm{XOR}$",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৪৪. সত্যক সারণিটি কোন গেইটকে নির্দেশ করে? [সি. বো. ২৩]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৪৬. উদ্দীপকের F এর সমতুল্য লজিক গেইট কোনটি? [রা. বো. ১৯]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৪৮. A, B, C এর মান কোনটি? [ঢা. বো. ২৫]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৫১. উদ্দীপকের লজিক সার্কিটের আউটপুট সমীকরণ কোন গেইটের সমতুল্য? [য. বো. ২৩]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৫৩. $\\mathrm{F}$ এর সরলীকৃত মান কোনটি? [দি. বো. ২৩]",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৫৪. $\\mathrm{F}$ এর সরলীকৃত মানকে মোট কয়টি মৌলিক গেট দ্বারা বাস্তবায়ন সম্ভব? [দি. বো. ২৩]",
    options: ["$2$", "$3$", "$4$", "$5$"],
    correct_answer: "$3$",
  ...
  },
  {
    id: 155,
    topic: "৬. লজিক গেইট",
    question_text: "১৫৫. $\\mathrm{Y = \\overline{A}.B+C}$ বুলিয়ান সমীকরণ বাস্তবায়ণ করতে মোট কয়টি মৌলিক গেইট প্রয়োজন?",
    options: ["$2$", "$3$", "$4$", "$5$"],
    correct_answer: "$3$",
  ...
  },
  {
    ...
    topic: "৬. লজিক গেইট",
    stimulus: "[এখানে চিত্র ছিল]",
    question_text: "১৫৬. $\\mathrm{Y}$ এর সরলীকৃত মান হলো- [কু. বো. ২৪]",
